...
import com.donga.nature.npe.RetrofitRegion.Region;
import com.donga.nature.npe.RetrofitRegion.Repo;
                ...
                public void onResponse(Call<Repo> call, Response<Repo> response) {
                    if (response.isSuccessful()) {
                        ...
                        for (int i = 0; i < townName.size(); i++) {
                            madapter.addItem(ContextCompat.getDrawable(RegionActivity.this, R.drawable.side), townName.get(i).split(" ")[2]);
                        }
...
//                    Log.i("경도", "" + longitude.get(i));
                    ...
                    myIntent.putExtra("name", townName.get(i).split(" ")[2]);
    ...
    public void onStart() {
        ...
        Action viewAction = Action.newAction(
                ...
                Uri.parse("android-app://com.donga.nature.npe/http/host/path")
        );
