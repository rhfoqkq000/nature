...
import com.donga.nature.npe.RetrofitSuccess.Repo;
import com.donga.nature.npe.RetrofitSuccess.Success;
...
//                            intent.putExtra("dbTitle",name);
            ...
            Toast.makeText(SuccessActivity.this, "인터넷을 연결해주세요!", Toast.LENGTH_SHORT).show();
        }
